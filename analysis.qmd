...
### Limitations:
Adding Social_Econ_Div to the linear regression model changes the results significantly because it is likely a highly influential variable that explains a large portion of the variation in Avg_Mean_earning.
