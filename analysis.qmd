...
ggplot(education_data_new, aes(x = Med_Loan_Debt, y = Avg_Med_Earnings, color = Race_Group)) +
...
model_race <- lm(
  Med_earnings_After_10_Years ~ Perc_Undergrad_White + Perc_Undergrad_Black + Perc_Undergrad_Hispanic + Perc_Undergrad_Asian,
  data = education_cohort_data_cleaned
)
summary(model_race)

education_cohort_data_cleaned <- education_cohort_data_cleaned %>%
  mutate(Med_earnings_After_10_Years = as.numeric(as.character(Med_earnings_After_10_Years)))
