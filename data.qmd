...
The data is sourced from the U.S. Department of Education. It includes institution-level data files from the 1996-97 academic year through the 2022-23 academic year, containing aggregate information for each institution. The dataset was last updated on October 10, 2024, found [here] (https://collegescorecard.ed.gov/data).

## Background and Purpose of the  Data

The College Scorecard was created during the Obama Administration to provide transparent, accessible information to help students and families make informed decisions about higher education. It compiles data on metrics such as net price, graduation rates, student diversity, median graduate debt, salary data, and student loan repayment information.The goal was to create a federal tool that offers comprehensive institutional profiles, synthesizing complex and multi-dimensional aspects of higher education into understandable and standardized metrics.
...
The cleaned College Scorecard data can be found [here] (/scripts/load_and_clean_data.R).
