...
## Initial Analysis of Race-Based Completion Rates Across Elite Universities 
```{r}
education_data <- read_rds("dataset/education_cohort_data_cleaned.rds") |>
  filter(Acceptance_rate < .20) |>
...
*Note: "Elite University" is defined as a university with an acceptance rate of less than 20%.* 
...
### II. Socioeconomically Diverse Institutions Have Lower Median Earnings
