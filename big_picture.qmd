...
server <- function(input, output) {
  ...
  education_data <- read_rds("https://sussmanbu.github.io/ma4615-final-project-quarto/dataset/loan_refusal_clean.rds")
  
  # Aggregate data at the state level
  state_data <- education_data %>%
    group_by(State) %>%
    summarise(
      Avg_Median_Earnings = mean(Med_earnings_After_6_Years, na.rm = TRUE),
