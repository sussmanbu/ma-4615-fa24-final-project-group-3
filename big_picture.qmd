---
title: "Big Picture: Earn more on higher tuition schools?"
description: "A journey walking through our project"
toc: true
draft: FALSE
format:
  html:
...
![American Progress(1872) by John Gast displays an allegorical representation of the modernization of the west, signifying American-exceptionalist ideals in the held belief that the settlers had the divine right to expand](images/Manifest_destiny.png)

### Introduction
In a nation that once encoded slavery into law, that drove Native Americans from their homes and into reserves, sprouted contradictory ideals of freedom, liberty, and justice for all. The American Dream refers to the ideal that the United States is a land of opportunity and social mobility for people; that every person, regardless of their race, gender, and socioeconomic status, has the equal opportunity to succeed. Perpetuating the idea of a colorblind society, perhaps any skew in data - certain racial groups have higher crime rates or lower incomes - can simply be attributed to just that: they didn't work hard enough. They were given an opportunity for social mobility and failed to seize it. We must ask ourselves: Can anyone who works hard be successful? What is equality and have we reached it? Is the American Dream Real?
