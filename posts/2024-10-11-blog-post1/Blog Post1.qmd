...
From this data, it is possible to determine which cause of death depicts the largest disparity among the racial ratios. Although I am able to view the dataset, due to the PDF format of this data, analyzing it would pose as a challenge because it may have to be manually copied onto another format. Furthermore the titles for some of the colunms are a little inconsistent in terms of the ratio. For example, one column is “Black to White” and another is “White to Asian”; thus, the numbers on some of the columns may need to be inverted to ensure consistency and match the format of the others.
